...
import { User, Lock, Building, Brain, Users, Home, Calendar } from 'lucide-react';

// Simple Login Component with Brain Icon
const Login = ({ onLogin }) => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-gray-100 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-xl shadow-xl p-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-slate-800">Achieve</h1>
          <p className="text-slate-600 mt-1">SLP Therapy Management</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-slate-700 text-white py-3 px-4 rounded-lg hover:bg-slate-800 transition-colors font-medium text-lg"
          >
            Sign In
          </button>
        </form>
...
// Enhanced Dashboard with Modern Neutral Palette
