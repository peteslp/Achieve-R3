...
const mockStudents = [
  ...
  },
  {
    ...
    age: 11,
    grade: "5th Grade",
    diagnosis: ["Language Processing", "Executive Function"],
    therapyGoals: ["Working memory", "Narrative organization", "Academic language"],
    progressLevel: "Progressing",
    lastSession: "2024-06-10",
    nextIEP: "2024-11-08",
    sessionFrequency: "2x/week",
    recentProgress: { score: 72, trend: "improving" },
    caseManager: "Dr. Sarah Johnson",
    notes: "Strong progress in narrative skills. Working on academic vocabulary."
  },
  {
    id: 8,
    name: "Maya Patel",
    age: 5,
    grade: "Pre-K",
    diagnosis: ["Late Language Emergence", "Articulation"],
    therapyGoals: ["Vocabulary expansion", "Two-word combinations", "Play-based communication"],
    progressLevel: "Progressing",
    lastSession: "2024-06-11",
    nextIEP: "2024-08-22",
    sessionFrequency: "2x/week",
    recentProgress: { score: 65, trend: "improving" },
    caseManager: "Dr. Sarah Johnson",
    notes: "Making good progress with play-based therapy. Family engagement excellent."
  },
  {
    id: 9,
    name: "Ethan Cooper",
    age: 13,
    grade: "7th Grade",
    diagnosis: ["Traumatic Brain Injury", "Cognitive Communication"],
    therapyGoals: ["Memory strategies", "Problem solving", "Social communication"],
    progressLevel: "Needs Support",
    lastSession: "2024-06-09",
    nextIEP: "2024-09-30",
    sessionFrequency: "3x/week",
    recentProgress: { score: 52, trend: "stable" },
    caseManager: "Dr. Sarah Johnson",
    notes: "Slow but consistent progress. Requires continued intensive support."
  },
  {
    id: 10,
    ...
    therapyGoals: ["Verbal participation", "Anxiety management", "Peer interaction"],
    progressLevel: "Progressing",
    lastSession: "2024-06-10",
    nextIEP: "2024-10-15",
    sessionFrequency: "2x/week",
    recentProgress: { score: 63, trend: "improving" },
    caseManager: "Dr. Sarah Johnson",
    notes: "Increasing verbal responses in therapy. Working on generalization to classroom."
  },
  {
    id: 11,
    name: "Noah Williams",
    age: 8,
    grade: "2nd Grade",
    diagnosis: ["Phonological Disorder", "Reading Difficulties"],
    therapyGoals: ["Phoneme awareness", "Sound-letter correspondence", "Decoding skills"],
    progressLevel: "Progressing",
    lastSession: "2024-06-11",
    nextIEP: "2024-08-28",
    sessionFrequency: "2x/week",
    recentProgress: { score: 69, trend: "improving" },
    caseManager: "Dr. Sarah Johnson",
    notes: "Good progress with phonological awareness. Collaborating with reading specialist."
  },
  {
    id: 12,
    name: "Zoe Anderson",
    age: 6,
    grade: "1st Grade",
    diagnosis: ["Language Delay", "ADHD"],
    therapyGoals: ["Attention to task", "Following multi-step directions", "Expressive language"],
    progressLevel: "Progressing",
    lastSession: "2024-06-10",
    nextIEP: "2024-09-12",
    sessionFrequency: "2x/week",
    recentProgress: { score: 61, trend: "improving" },
    caseManager: "Dr. Sarah Johnson",
    notes: "Improving attention span. Using visual supports and movement breaks effectively."
  }
];
